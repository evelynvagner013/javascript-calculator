  ...
  handleClick = (value) => {
    ...
    switch(true){
      ...
      case value === "=":
        ...
        break;
      //Se o botao "%" é clicado
      case value=== "%":  
        currentNumber = (eval(currentNumber) /100) .toString();
        operatorFlag = false;
        this.setState({dotFlag:true});
        break;    
      // Se o botão "." é clicado
      ...
      <div className="container">
        ...
        <div className="row">
          <div id="calculator">
            ...
            <Operator id="multiply" value="*" handleClick={this.handleClick} />
            <Operator id="percentage" value="%" handleClick={this.handleClick} /> <br/>
            {/* Botões de número */}
        ...
        <footer className="text-center">
          <span>Fatec <i className="far fa fa-copyright"></i> 2024</span>
        </footer>
      </div>
    );
  } 
...
class Equals extends React.Component{
  ...
  render(){
    return(
  <button id={this.props.id} className="btn btn-dark btn-lg" onClick={this.runParentHandleClick}>{this.props.value}</button>
  )
  }
}
